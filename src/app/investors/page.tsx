        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="/startups" className="text-slate-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">For Entrepreneurs</a>
              <a href="/investors" className="text-white px-3 py-2 rounded-md text-sm font-medium bg-slate-700/50">For Investors</a>
