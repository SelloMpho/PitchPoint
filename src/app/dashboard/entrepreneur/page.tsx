                ...
                <div className="lg:w-3/4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Link href={startup.website} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 transition-colors duration-200">
                        {startup.website}
                      </Link>
                    </div>
                  </div>
...
function Navbar() {
  return (
    <nav className="navbar-glass fixed top-0 w-full z-50 border-b border-slate-700/50 backdrop-blur-sm bg-slate-900/80">
